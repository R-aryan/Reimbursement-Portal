namespace ReimbursementDataAccessLayer.Migrations
{
    ...
    public partial class InitialMigrationn : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        BankName = c.String(nullable: false, maxLength: 255),
                        AccountNymber = c.String(nullable: false, maxLength: 12),
                        PanNumber = c.String(nullable: false, maxLength: 10),
